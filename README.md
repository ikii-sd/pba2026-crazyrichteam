...
Untuk dapat menembus dan menghancurkan batas kendala dari proses manual linguistik tersebut, kami merancang secara arsitektural sistem algoritma *Natural Language Processing* (NLP) hulu-ke-hilir.
